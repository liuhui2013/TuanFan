...
/**
 * Created by roffee on 2017/6/23 08:50.
 ...
 * 添加水平分割线：高度为2px，颜色为灰色
 ...
 //垂直+水平分割线
 recyclerView.addItemDecoration(new DividerItemDecoration(ListRecycle.this, DividerItemDecoration.BOTH_SET));
 带颜色的分割线
...
public class RecycleViewDivider extends RecyclerView.ItemDecoration {
    ...
    public void setMargin(int Hleft, int Vtop, int Hright, int Vbottom){
        marginRect.left = Hleft;
        marginRect.top = Vtop;
        marginRect.right = Hright;
        marginRect.bottom = Vbottom;
    }
    /**
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        final int x = parent.getPaddingLeft() + marginRect.left;
        final int width = parent.getMeasuredWidth() - parent.getPaddingRight() -  marginRect.left -  marginRect.right;
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        final int top = parent.getPaddingTop() + marginRect.top;
        final int bottom = parent.getMeasuredHeight() - parent.getPaddingBottom() - marginRect.top - marginRect.bottom;
        final int childSize = parent.getChildCount();
        for (int i = 0; i < childSize; i++) {
            final View child = parent.getChildAt(i);
