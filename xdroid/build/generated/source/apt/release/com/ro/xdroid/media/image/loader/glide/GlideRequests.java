...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.ro.xdroid.media.image.loader.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.ro.xdroid.media.image.loader.glide.GlideOptions().apply(toSet));
    }
  }
}
